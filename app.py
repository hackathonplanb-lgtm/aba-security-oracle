...
st.markdown("**Built by: Team Udo (resilience) – Deep Funding Hackathon 2025**")
...
<div style="position: fixed; bottom: 40px; left: 40px; width: 420px; height: 340px; 
 ...
 <h4 style="margin:0 0 20px 0; text-align:center; color:#8B0000; font-size:20px;"><b>MAP LEGEND</b></h4>
